...
def get_basic_params():
    ...
    basic_params = {
        ...
        "duration" :  2500, # 700, # 1500, # #, # 10200,  # 10 sec simulation time
        "step_duration" : 0,
